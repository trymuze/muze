...
const GalileoDesign: NextPage = () => {
  return (
    <div className="w-full h-[1863px] relative bg-white flex flex-col items-start justify-start tracking-[normal] mq950:h-auto mq950:min-h-[1862.9]">
      <main className="w-full my-0 mx-[!important] absolute h-full top-[0px] right-[0px] bottom-[0px] left-[0px] bg-whitesmoke flex flex-col items-center justify-start pt-0 px-0 pb-10 box-border gap-[36px_0px] max-w-full mq700:gap-[36px_0px]">
        <Depth2Frame />
              ...
              <div className="mb-[-16px] self-stretch flex flex-col items-start justify-end pt-0 px-10 pb-10 box-border min-h-[480px] max-w-full shrink-0 mq450:gap-[32px_0px]">
                <div className="self-stretch flex flex-col items-start justify-start max-w-full">
                  <div className="self-stretch flex flex-col items-start justify-start gap-[8px_0px] max-w-full">
                    <div className="self-stretch flex flex-col items-start justify-start max-w-full">
                      <div className="self-stretch flex flex-col items-start justify-start max-w-full">
                        <h1 className="m-0 text-black relative text-inherit tracking-[-1.58px] leading-[60px] font-extrabold font-inherit inline-block max-w-full mq450:text-10xl mq450:leading-[36px] mq950:text-[38px] mq950:leading-[48px]">
